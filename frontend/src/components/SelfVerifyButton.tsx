  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.1] text-[#A1A1A1] text-xs font-medium hover:text-white hover:border-[#E8500C]/30 transition"
      >
